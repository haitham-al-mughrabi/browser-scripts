(function() {
    ...
    function showKeyInput() {
        ...
        instruction.textContent = 'Enter the sessionStorage key to retrieve:';
        ...
        suggestionLabel.textContent = 'sessionStorage Keys:';
        ...
        // Fetch all keys from sessionStorage and create suggestion buttons
        ...
        if (sessionStorageKeys.length === 0) {
            ...
            noneMsg.textContent = 'No keys found in sessionStorage.';
